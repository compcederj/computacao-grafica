# Computação Gráfica
Repositório de provas antigas da Disciplina **Computação Gráfica** do curso de **Tecnologia em Sistemas de Computaćao** da **UFF** ministrado através do **CEDERJ**.
...
`git clone https://github.com/compcederj/computacao-grafica.git`
...
`git clone git@github.com:compcederj/computacao-grafica.git`
...
# Computação Gráfica
Repositório de provas antingas da Disciplina **Computação Gráfica** do curso de **Tecnologia em Sistemas de Computaçao** da **UFF** ministrado através do **CEDERJ**.
